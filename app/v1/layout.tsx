    ...
    <>
      ...
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        @media(max-width:920px){
          .v1-page .v1-media{top:86px !important;right:13px !important;width:47% !important;height:335px !important;opacity:1 !important;z-index:2 !important;overflow:visible !important;background:transparent !important;}
