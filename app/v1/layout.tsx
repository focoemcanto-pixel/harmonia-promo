    ...
    <>
      ...
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        @media(max-width:920px){
          .v1-page .v1-media{top:86px !important;right:-7px !important;width:56% !important;height:335px !important;opacity:1 !important;z-index:2 !important;overflow:visible !important;background:transparent !important;}
          ...
          .v1-page .v1-hero-img{right:-30% !important;top:-10% !important;width:175% !important;height:128% !important;object-fit:cover !important;object-position:center top !important;mix-blend-mode:lighten !important;opacity:1 !important;filter:saturate(1.12) contrast(1.12) brightness(1.08) drop-shadow(0 18px 28px rgba(0,0,0,.46)) !important;mask-image:linear-gradient(180deg,#000 0%,#000 84%,transparent 100%) !important;-webkit-mask-image:linear-gradient(180deg,#000 0%,#000 84%,transparent 100%) !important;background:transparent !important;}
