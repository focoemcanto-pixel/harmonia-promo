  ...
  return (
    <>
      ...
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        .v1-page .v1-video-card{row-gap:20px !important;}
        .v1-page .v1-video-card p{margin-bottom:8px !important;}
        @media(max-width:920px){
          .v1-page .v1-copy{margin-top:-48px !important;}
          .v1-page .v1-media{top:38px !important;right:26px !important;width:47% !important;height:335px !important;opacity:1 !important;z-index:2 !important;overflow:visible !important;background:transparent !important;}
          ...
          .v1-page .v1-hero-img{right:-47% !important;top:-10% !important;width:205% !important;height:128% !important;object-fit:cover !important;object-position:35% top !important;mix-blend-mode:lighten !important;opacity:1 !important;filter:saturate(1.12) contrast(1.12) brightness(1.08) drop-shadow(0 18px 28px rgba(0,0,0,.46)) !important;mask-image:linear-gradient(180deg,#000 0%,#000 84%,transparent 100%) !important;-webkit-mask-image:linear-gradient(180deg,#000 0%,#000 84%,transparent 100%) !important;background:transparent !important;}
