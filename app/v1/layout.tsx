    ...
    <>
      ...
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        @media(max-width:920px){
          ...
          .v1-page .v1-hero-img{right:-47% !important;top:-10% !important;width:245% !important;height:128% !important;object-fit:contain !important;object-position:right top !important;mix-blend-mode:lighten !important;opacity:1 !important;filter:saturate(1.12) contrast(1.12) brightness(1.08) drop-shadow(0 18px 28px rgba(0,0,0,.46)) !important;mask-image:linear-gradient(180deg,#000 0%,#000 84%,transparent 100%) !important;-webkit-mask-image:linear-gradient(180deg,#000 0%,#000 84%,transparent 100%) !important;background:transparent !important;}
