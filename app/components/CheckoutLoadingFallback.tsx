  ...
  return (
    ...
    >
      ...
      >
        ...
        <strong style={{ display: 'block', fontSize: 20, lineHeight: 1.2, marginBottom: 8 }}>
          🔒 Abrindo checkout seguro...
        </strong>
        <p style={{ margin: 0, color: 'rgba(255,255,255,.72)', fontSize: 15, lineHeight: 1.45 }}>
