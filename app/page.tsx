  ...
  return (
    <main>
      <style dangerouslySetInnerHTML={{ __html: `
        .hero-photo-wrap::before{top:41%!important;}
        .hero-marcos{transform:translateX(5%) translateY(-42px)!important;}
        .hero-authority + h1{margin-top:-.25rem!important;}
        @media (max-width:768px){
          .hero-photo-wrap::before{top:41%!important;}
          .hero-marcos{transform:translateX(5%) translateY(-38px)!important;}
          .hero-authority + h1{margin-top:-.15rem!important;}
        }
      ` }} />
