  ...
  return (
    <main className="v2x">
      ...
      <section className="v2-section">
        <div className="v2-wrap">
          <h2>O caminho para não se atrapalhar na <span>divisão vocal.</span></h2>
      ...
      <section className="v2-section alt">
        <div className="v2-wrap v2-guarantee-box">
          <img className="v2-guarantee-img" src="/images/oferta/%20garantia-7-dias.webp" alt="Garantia de 7 dias" loading="lazy" decoding="async" />
          <div>
            ...
            <a className="v2-btn v2-green-btn" href={checkoutUrl} target="_blank" rel="noreferrer">✅ Garantir minha vaga sem risco</a>
          </div>
        </div>
      </section>

      <section className="v2-section">
        <div className="v2-wrap v2-mentor-box">
          <div>
          ...
          <img className="v2-mentor-img" src="/images/mentor/%20marcos-cruz.webp" alt="Marcos Cruz cantando" loading="lazy" decoding="async" />
        </div>
      </section>

      <section className="v2-section alt v2-faq">
        <div className="v2-wrap">
