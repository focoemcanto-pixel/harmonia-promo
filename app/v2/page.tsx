  ...
  return (
    <main className="v2x">
      <style dangerouslySetInnerHTML={{ __html: `
        .v2x{--gold:#f5b73d;--gold2:#ffe18a;--line:rgba(245,183,61,.22);font-family:Arial,sans-serif;background:#030303;color:#fff;overflow:hidden}.v2x *{box-sizing:border-box}.v2-wa{position:fixed;right:18px;bottom:18px;z-index:80;width:56px;height:56px;border-radius:999px;background:#25d366;color:#fff;display:grid;place-items:center;box-shadow:0 16px 34px rgba(0,0,0,.4)}.v2-wrap{width:min(1180px,100%);margin:0 auto;padding:0 22px}.v2-hero{min-height:100svh;padding:22px 0 52px;position:relative;isolation:isolate;background:radial-gradient(circle at 72% 26%,rgba(245,183,61,.22),transparent 28%),radial-gradient(circle at 18% 78%,rgba(112,240,255,.08),transparent 24%),linear-gradient(180deg,#120603 0%,#050505 70%,#020202 100%)}.v2-hero:before{content:'';position:absolute;inset:0;background-image:linear-gradient(rgba(245,183,61,.035) 1px,transparent 1px),linear-gradient(90deg,rgba(245,183,61,.035) 1px,transparent 1px);background-size:38px 38px;opacity:.46;mask-image:linear-gradient(180deg,#000,transparent 86%)}.v2-shell{position:relative;min-height:calc(100svh - 44px);border:1px solid rgba(245,183,61,.25);border-radius:34px;overflow:hidden;padding:30px;background:linear-gradient(135deg,rgba(255,255,255,.06),rgba(255,255,255,.015));box-shadow:0 32px 110px rgba(0,0,0,.55)}.v2-shell:before{content:'';position:absolute;right:-18%;top:8%;width:62%;height:52%;background:radial-gradient(circle,rgba(245,183,61,.2),transparent 64%);filter:blur(18px)}.v2-shell:after{content:'';position:absolute;inset:auto -10% -24% -10%;height:44%;background:radial-gradient(ellipse at center,rgba(245,183,61,.18),transparent 66%);filter:blur(20px);opacity:.9}.v2-brand{position:relative;z-index:8;text-transform:uppercase;font-weight:1000;letter-spacing:.13em;margin-bottom:18px}.v2-brand small{display:block;font-size:.63rem;color:rgba(255,255,255,.62);letter-spacing:.34em;margin-top:3px}.v2-hero-grid{position:relative;z-index:12;display:grid;grid-template-columns:minmax(0,1.02fr) minmax(330px,.86fr);gap:28px;align-items:center;min-height:calc(100svh - 145px)}.v2-copy{text-align:left}.v2-chip{display:inline-flex;gap:10px;align-items:center;border:1px solid rgba(245,183,61,.34);border-radius:999px;background:rgba(245,183,61,.09);padding:10px 15px;font-size:.75rem;font-weight:900;letter-spacing:.13em;text-transform:uppercase}.v2-title{max-width:760px;font-size:clamp(3.4rem,7vw,7.2rem);line-height:.84;letter-spacing:-.075em;margin:22px 0 18px;font-weight:1000;text-transform:uppercase}.v2-title span{display:block;color:var(--gold);text-shadow:0 0 36px rgba(245,183,61,.35)}.v2-sub{max-width:650px;font-size:clamp(1.06rem,1.8vw,1.28rem);line-height:1.5;color:rgba(255,255,255,.84);margin:0 0 20px}.v2-sub strong{color:var(--gold2)}.v2-proof{display:flex;align-items:center;gap:14px;margin:14px 0 0;font-weight:900}.v2-bubbles{display:flex}.v2-bubble{width:43px;height:43px;border-radius:999px;border:2px solid rgba(245,183,61,.85);margin-right:-10px;background:#111;display:grid;place-items:center;font-size:.75rem}.v2-proof span{color:var(--gold)}.v2-stage{position:relative;z-index:18;width:min(420px,100%);aspect-ratio:9/16;margin:0 auto -24px;pointer-events:none;filter:drop-shadow(0 34px 58px rgba(0,0,0,.6))}.v2-stage:before{content:'';position:absolute;inset:6% -8% -3%;border-radius:34px;background:radial-gradient(circle at 50% 72%,rgba(245,183,61,.22),transparent 44%);filter:blur(14px);z-index:-1}.v2-video{position:absolute;inset:0;width:100%;height:100%;object-fit:contain;object-position:center bottom}.v2-hotspot{position:absolute;left:20%;bottom:6%;width:60%;height:10%;z-index:40;display:block;opacity:0;cursor:pointer;pointer-events:auto}.v2-scroll{position:absolute;left:30px;bottom:24px;z-index:20;color:rgba(255,255,255,.58);font-size:.78rem;text-transform:uppercase;letter-spacing:.18em}.v2-section{position:relative;padding:76px 0;background:#050505}.v2-section.alt{background:#0a0a0a}.v2-section h2{font-size:clamp(2.2rem,5vw,4.8rem);line-height:.92;letter-spacing:-.055em;text-transform:uppercase;margin:0 0 20px;font-weight:1000}.v2-section h2 span{color:var(--gold)}.v2-section p{font-size:1.05rem;line-height:1.65;color:rgba(255,255,255,.74)}.v2-cards{display:grid;grid-template-columns:repeat(3,1fr);gap:18px;margin-top:30px}.v2-card{border:1px solid rgba(255,255,255,.1);background:linear-gradient(145deg,rgba(255,255,255,.06),rgba(255,255,255,.018));border-radius:24px;padding:24px;min-height:210px}.v2-card b{display:block;color:var(--gold);font-size:1.7rem;margin-bottom:14px}.v2-method{border:1px solid var(--line);border-radius:30px;padding:clamp(20px,4vw,36px);display:grid;grid-template-columns:.82fr 1.18fr;gap:30px;align-items:center;background:radial-gradient(circle at 90% 0,rgba(245,183,61,.15),transparent 30%),rgba(255,255,255,.035)}.v2-video-box{border-radius:24px;overflow:hidden;box-shadow:0 24px 70px rgba(0,0,0,.35)}.v2-offer{background:radial-gradient(circle at 50% 0,rgba(245,183,61,.18),transparent 35%),#050505}.v2-offer-box{border:1px solid rgba(245,183,61,.3);border-radius:34px;padding:clamp(24px,5vw,48px);background:linear-gradient(135deg,rgba(245,183,61,.12),rgba(255,255,255,.025));display:grid;grid-template-columns:1fr .9fr;gap:34px;align-items:center}.v2-offer-list{list-style:none;padding:0;margin:26px 0 0;display:grid;gap:12px}.v2-offer-list li{font-weight:800;color:rgba(255,255,255,.86)}.v2-offer-list li:before{content:'✓';color:var(--gold);margin-right:10px}.v2-panel{border:1px solid rgba(245,183,61,.24);border-radius:28px;padding:30px;background:#070707;text-align:center}.v2-big{font-size:5rem;font-weight:1000;letter-spacing:-.09em;line-height:.9}.v2-big span{color:var(--gold)}.v2-btn{display:flex;justify-content:center;align-items:center;text-align:center;text-decoration:none;color:#111;background:linear-gradient(135deg,#ffe27d,#f2a51d);border-radius:22px;padding:22px 24px;font-weight:1000;text-transform:uppercase;letter-spacing:.015em;box-shadow:0 26px 55px rgba(245,183,61,.35),inset 0 1px 0 rgba(255,255,255,.68)}@media(max-width:920px){.v2-wrap{padding:0 12px}.v2-hero{padding:8px 0 28px}.v2-shell{border-radius:26px;padding:18px 16px 24px;min-height:auto}.v2-brand{text-align:center;font-size:.92rem;margin-bottom:12px}.v2-brand small{font-size:.56rem}.v2-hero-grid{display:block;min-height:auto}.v2-copy{text-align:center}.v2-chip{font-size:.61rem;padding:8px 11px}.v2-title{font-size:clamp(2.5rem,12.6vw,3.55rem);line-height:.87;margin:15px auto 12px;max-width:98%}.v2-sub{font-size:1rem;line-height:1.45;max-width:95%;margin:0 auto 13px}.v2-proof{justify-content:center;font-size:.95rem;gap:12px;margin:0 0 8px}.v2-bubble{width:38px;height:38px;font-size:.68rem}.v2-stage{width:min(360px,88vw);margin-top:-16px;margin-bottom:-40px}.v2-hotspot{left:18%;bottom:6%;width:64%;height:10%}.v2-scroll{display:none}.v2-section{padding:54px 0}.v2-cards{grid-template-columns:1fr}.v2-method,.v2-offer-box{grid-template-columns:1fr}.v2-card{min-height:auto}.v2-big{font-size:4.2rem}}@media(max-width:420px){.v2-stage{width:92vw;margin-left:auto;margin-right:auto;margin-top:-18px;margin-bottom:-34px}.v2-title{font-size:clamp(2.42rem,12.4vw,3.35rem)}}
      ` }} />
