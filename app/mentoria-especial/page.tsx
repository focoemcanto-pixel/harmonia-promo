    ...
    <main className="mentor-upsell">
      ...
      <section className="mu-hero mu-center">
        <div className="mu-container">
          ...
          <div className="mu-alert">⚠️ Fechando esta página, você perde acesso a esta condição especial da Mentoria Foco em Canto.</div>
          <a className="mu-btn" href="/mentoria-especial">Ver planos especiais da mentoria</a>
      ...
      <section className="mu-section mu-dark">
        <div className="mu-container mu-grid">
          ...
          <div className="mu-copy">
            ...
            <a className="mu-btn" href="/mentoria-especial">Escolher meu plano</a>
          </div>
        </div>
      </section>
      ...
      <section className="mu-section mu-dark">
        <div className="mu-container mu-grid">
          <div className="mu-copy">
            ...
            <a className="mu-btn" href="/mentoria-especial">Ver planos especiais</a>
          </div>
      ...
      <section className="mu-final">
        <div className="mu-narrow">
          ...
          <a className="mu-btn" href="/mentoria-especial">Escolher meu plano agora</a>
        </div>
      </section>

      <div className="mu-floating"><div className="mu-floating-inner"><div><strong>Oferta especial liberada:</strong> planos da Mentoria Foco em Canto</div><a className="mu-btn" href="/mentoria-especial">Ver planos</a></div></div>
    </main>
  )
}
