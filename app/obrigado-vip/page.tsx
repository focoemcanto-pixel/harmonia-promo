...
function HeroCta() {
  return (
    <a className="vip-primary-button" href="#oferta-vip">
      Quero o VIP por R$ 5,00
    </a>
  )
}

function KiwifyUpsell() {
  return (
    <div className="kiwify-wrap" id="kiwify-upsell-yvnJeJH" data-upsell-url="" data-downsell-url="">
      <button id="kiwify-upsell-trigger-yvnJeJH" className="vip-primary-button">
        Sim! Quero desbloquear meu Acesso VIP por R$ 5,00
      </button>
      <div id="kiwify-upsell-cancel-trigger-yvnJeJH" className="vip-decline">
...
export const metadata = {
  title: 'Desbloqueie o Acesso VIP por R$ 5 — Escola Foco em Canto',
  description: 'Oferta exclusiva para liberar recursos premium da Escola Foco em Canto: primeiro mês por R$ 5,00 e depois R$ 19,90/mês.',
}
    ...
    <main className="vip-page">
      ...
      <section className="vip-hero">
        <div className="vip-shell vip-hero-grid">
          <div>
            ...
            <div className="vip-alert">🔥 Oferta exclusiva desta página: primeiro mês por apenas R$ 5,00. Depois R$ 19,90/mês.</div>
            <div className="vip-hero-actions"><HeroCta /></div>
          </div>
      ...
      <section className="vip-offer" id="oferta-vip">
        <div className="vip-shell">
          <div className="vip-offer-box">
            ...
            <h2>Desbloqueie o Acesso VIP por apenas R$ 5,00.</h2>
      ...
      <div className="vip-footer-sticky">
        <div className="vip-footer-inner">
          <div><strong>Primeiro mês por R$ 5,00</strong><br /><span className="vip-muted">Depois R$ 19,90/mês. Oferta exclusiva para compradores do Foco em Harmonia.</span></div>
          <a className="vip-primary-button" href="#oferta-vip">Ativar oferta de R$ 5,00</a>
        </div>
      </div>
