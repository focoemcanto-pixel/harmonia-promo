...
const offerItems = [
  ...
  'Teste de Extensão e Classificação',
  'Atividades práticas para o dia a dia',
  'Adição periódica de novos conteúdos',
  'Acesso vitalício',
]
  ...
  return (
    <main className="lp-b">
      <style dangerouslySetInnerHTML={{ __html: `
        .lp-b{background:#0D0C0F;color:#EDEDED;font-family:Arial,sans-serif;overflow-x:hidden}.lp-b *{box-sizing:border-box}.lp-b strong,.lp-b .green{color:#23D9B5}.b-container{width:min(1100px,100%);margin:0 auto;padding:0 24px}.b-narrow{width:min(760px,100%);margin:0 auto;padding:0 24px}.b-center{text-align:center}.b-section{padding:64px 0}.b-dark{background:#0D0C0F}.b-gray{background:#D9D9D9;color:#0D0C0F}.b-white{background:#FFFAFA;color:#0D0C0F}.b-panel{background:#1d1d1d}.b-title{font-family:Sora,Arial,sans-serif;font-weight:600;line-height:1.35;letter-spacing:.3px;margin:0 0 24px}.b-title.hero{font-size:29px;color:#EDEDED}.b-title.section{font-size:24px;color:inherit}.b-lead{font-family:Montserrat,Arial,sans-serif;font-size:16px;line-height:22px;color:#A0A0A0;margin:0 auto 26px;max-width:720px}.b-sale-img{display:block;width:min(560px,86vw);height:auto;margin:56px auto 24px}.b-hero{padding:0 0 52px;background:#0D0C0F}.b-video{width:min(82%,900px);margin:28px auto 22px}.b-video .video-facade{margin:0 auto;border-radius:0;box-shadow:none}.b-btn{display:inline-flex;align-items:center;justify-content:center;border-radius:6px;background:linear-gradient(232deg,#46B581,#21724C);color:#fff;font-family:Manrope,Arial,sans-serif;font-weight:800;font-size:16px;text-align:center;min-height:70px;padding:25px 130px;max-width:100%;transition:transform .18s ease,filter .18s ease;text-transform:uppercase}.b-btn:hover{transform:scale(1.04);filter:brightness(1.05)}.b-gift-note{font-family:Sora,Arial,sans-serif;font-size:13px;font-weight:600;letter-spacing:.3px;line-height:37px;margin:12px auto 0;color:#EDEDED;max-width:760px}.b-gift{opacity:0;pointer-events:none;animation:bFadeGift .7s ease both;animation-delay:540s}.b-gift:focus{outline:2px solid #23D9B5;outline-offset:4px}.b-indicators{padding:0 0 80px;background:#0D0C0F}.b-indicator-box{width:min(80%,880px);min-height:100px;margin:0 auto;border:1px solid #fff;border-radius:6px;display:flex;align-items:center;justify-content:space-between;padding:20px}.b-indicator{flex:1;display:flex;align-items:center;justify-content:center;gap:10px;font-family:Montserrat,Arial,sans-serif;font-size:14px;font-weight:700;color:#EDEDED}.b-indicator+.b-indicator{border-left:1px solid #EDEDED}.b-icon{color:#23D9B5;font-size:20px}.b-split{display:grid;grid-template-columns:1fr 1fr;gap:28px;align-items:center}.b-list{display:flex;flex-direction:column;gap:28px;margin:0;padding:0;list-style:none}.b-list li{border-bottom:1px solid #4A4A4A;padding-bottom:24px;font-family:Montserrat,Arial,sans-serif;font-size:14px;line-height:1.7;color:#fff}.b-list li:before{content:'✓';color:#46B581;font-weight:700;margin-right:10px}.b-img{display:block;max-width:76%;margin:0 auto}.b-copy{font-family:Montserrat,Arial,sans-serif;font-size:14px;line-height:1.75;color:#B9B9B9}.b-callout{border:1px solid #23D9B5;border-radius:6px;padding:15px 20px;color:#fff;font-weight:700;margin:22px 0}.b-learn-header{border-bottom:1px solid #A0A0A0;padding-bottom:32px;margin-bottom:42px}.b-cards{display:flex;gap:52px;justify-content:center;align-items:stretch;flex-wrap:wrap}.b-card{width:270px;min-height:715px;background:#161616;border-radius:12px;overflow:hidden;color:#fff;box-shadow:0 0 0 1px rgba(255,255,255,.04)}.b-card-img{height:268px;margin:12px 20px 0;background-size:cover;background-position:top center;background-repeat:no-repeat;position:relative;border-radius:0;overflow:hidden}.b-card-img:before{content:'';position:absolute;inset:0;background:linear-gradient(90deg,rgba(255,255,255,.75),rgba(255,255,255,.1) 48%,rgba(255,255,255,.75));mix-blend-mode:screen;opacity:.5}.b-card-img:after{content:'';position:absolute;left:0;right:0;bottom:0;height:46%;background:linear-gradient(180deg,rgba(22,22,22,0),#161616 88%)}.b-card-body{position:relative;margin-top:-34px;padding:0 30px 34px}.b-step-label{display:inline-flex;align-items:center;justify-content:center;width:112px;height:68px;background:#23D9B5;color:#070707;border-radius:6px;font-family:Manrope,Arial,sans-serif;font-size:14px;font-weight:800;margin-bottom:20px}.b-card h3{font-family:Sora,Arial,sans-serif;font-size:16px;font-weight:800;line-height:1.25;margin:0 0 32px;color:#fff}.b-divider{height:1px;background:#6D6D6D;margin:0 0 48px}.b-card p{font-family:Manrope,Arial,sans-serif;font-size:14px;line-height:1.6;color:#A0A0A0;margin:0}.b-test-head{display:flex;align-items:center;justify-content:space-between;border-top:1px solid #A0A0A0;padding-top:32px;margin-bottom:32px}.b-test-head .b-title{width:min(560px,100%)}.b-comment{width:44px;height:44px;border-radius:4px;background:#23D9B5;color:#fff;display:grid;place-items:center;font-size:24px}.lp-b .carousel-wrapper{max-width:1180px}.lp-b .carousel-slide{flex:0 0 31%;max-width:340px}.b-access .video-facade{box-shadow:none;border-radius:0}.b-access h2{font-size:28px}.b-trust-row{max-width:880px;margin:42px auto 0;border:1px solid #fff;border-radius:6px;display:flex;justify-content:space-around;gap:0;padding:24px}.b-trust-row div{flex:1;text-align:center;font-weight:800}.b-trust-row div+div{border-left:1px solid rgba(255,255,255,.45)}.b-mega{background:#000;padding:80px 0}.b-mega-grid{display:grid;grid-template-columns:.85fr 1.15fr;gap:50px;align-items:center}.b-old-price{font-size:24px;color:#fff;margin-bottom:88px}.b-old-price s{color:#e52525;font-weight:800}.b-mega-price{font-size:64px;line-height:1;font-weight:900;color:#23D9B5;margin:0 0 60px}.b-mega-cash{font-size:18px;color:#fff;margin-bottom:40px}.b-mega-list{list-style:none;margin:0 0 30px;padding:0}.b-mega-list li{font-size:24px;line-height:1.35;color:#fff;margin:4px 0}.b-mega-list li:before{content:'✓';color:#63c7f0;margin-right:10px}.b-mega-logo{width:100%;max-width:560px;margin:0 auto}.b-mega-sub{font-size:28px;font-weight:800;line-height:1.35;color:#fff;max-width:520px;margin:26px auto 0}.b-guarantee{background:#1d1d1d;padding:70px 0}.b-guarantee-img{max-width:320px;margin:0 auto}.b-guarantee h2{font-size:28px;color:#fff}.b-guarantee p,.b-mentor p{font-size:18px;line-height:1.45;color:#a8a8a8}.b-mentor{background:#0D0C0F;padding:70px 0}.b-mentor-img{max-width:520px;margin:0 auto}.b-mentor h2{font-size:28px;color:#fff}.b-faq details{border:1px solid rgba(255,255,255,.15);border-radius:8px;padding:18px 20px;margin:12px 0;background:rgba(255,255,255,.04)}.b-faq summary{cursor:pointer;font-weight:800}.b-faq p{color:#A0A0A0;margin:12px 0 0;line-height:1.7}.b-final{padding:70px 0;background:#0D0C0F;text-align:center}.lp-b>.countdown{display:grid!important;grid-template-columns:1fr 1fr!important;gap:10px!important;width:100%!important;background:#050505!important;border:0!important;padding:0 0 12px!important;margin:0!important}.lp-b .countdown-label,.lp-b .count-separator{display:none!important}.lp-b .count-box{height:132px!important;background:#ee6f70!important;border-radius:0!important;display:flex!important;flex-direction:column!important;align-items:center!important;justify-content:center!important;color:#fff!important}.lp-b .count-box strong{font-size:64px!important;line-height:.9!important;font-weight:400!important;color:#fff!important;font-family:Arial,sans-serif!important}.lp-b .count-box span{font-size:20px!important;line-height:1.1!important;font-weight:700!important;color:#fff!important;font-family:Georgia,serif!important;margin-top:8px!important}@keyframes bFadeGift{0%{opacity:0;transform:translateY(10px);pointer-events:none}100%{opacity:1;transform:translateY(0);pointer-events:auto}}@media(max-width:768px){.b-container,.b-narrow{padding:0 24px}.b-sale-img{width:min(76vw,340px);margin:34px auto 20px}.b-hero{padding-top:0}.b-title.hero{font-size:20px;line-height:1.2}.b-title.section{font-size:22px;line-height:1.2;text-align:center}.b-lead{font-size:14px;line-height:19px;max-width:290px}.b-video{width:100%;margin-top:22px}.b-btn{font-size:12px;min-height:60px;padding:20px 25px}.b-gift-note{font-size:12px;line-height:1.2;max-width:317px}.b-indicators{padding-bottom:32px}.b-indicator-box{width:100%;min-height:80px;padding:10px}.b-indicator{font-size:10px;flex-direction:column;gap:5px;text-align:center}.b-indicator+.b-indicator{border-left:none}.b-split{grid-template-columns:1fr;gap:30px}.b-benefits .b-split{display:flex;flex-direction:column-reverse}.b-img{max-width:90%}.b-list li{font-size:13px}.b-gray,.b-white,.b-panel,.b-dark{padding-left:0;padding-right:0}.b-test-head{display:block;text-align:center}.b-comment{margin:0 auto}.lp-b .carousel-slide{flex:0 0 82%;max-width:340px}.b-cards{gap:28px}.b-card{width:100%;max-width:300px;min-height:auto}.b-card-img{height:270px}.b-card-body{padding:0 30px 34px}.b-divider{margin-bottom:28px}.b-trust-row{display:grid;gap:14px}.b-trust-row div+div{border-left:0}.b-mega-grid{grid-template-columns:1fr;text-align:center}.b-old-price{margin-bottom:40px}.b-mega-price{font-size:48px;margin-bottom:30px}.b-mega-list{text-align:left}.b-mega-list li{font-size:18px}.b-mega-sub{font-size:22px}.b-guarantee-img{max-width:240px}.b-guarantee h2,.b-mentor h2{font-size:24px;text-align:center}.b-guarantee p,.b-mentor p{text-align:center;font-size:16px}.b-mentor .b-split{display:flex;flex-direction:column-reverse}.b-mentor-img{max-width:90%}.lp-b .count-box{height:92px!important}.lp-b .count-box strong{font-size:48px!important}.lp-b .count-box span{font-size:16px!important}}
      ` }} />
      ...
      <section className="b-hero b-center">
        <div className="b-narrow">
          <img className="b-sale-img" src="/images/hero/mega-semana-de-oferta.webp" alt="Mega semana de ofertas" />
      ...
      <section className="b-section b-dark b-center b-access">
        <div className="b-narrow">
          <VideoFacade videoId="yb-6zZv763k" title="Viagem pelo curso" thumbnailSrc="/images/videos/%20thumb-viagem-pelo-curso.webp" />
          <h2 className="b-title section">Aprenda a <strong>qualquer hora e em qualquer lugar!</strong></h2>
          <h3>ACESSO VITALÍCIO</h3>
          <div className="b-trust-row"><div>✅ 7 Módulos Gravados</div><div>✅ Treinamento 100% online</div><div>✅ Aulas direto ao ponto</div></div>
        </div>
      </section>

      <section className="b-mega">
        <div className="b-container b-mega-grid">
          <div>
            <div className="b-old-price">De: <s>R$397,00</s> Por:</div>
            <div className="b-mega-price">12 x 5,99</div>
            <div className="b-mega-cash">ou R$ 57,90 à vista</div>
            <ul className="b-mega-list">{offerItems.map((item) => <li key={item}>{item}</li>)}</ul>
            <a className="b-btn" href={checkoutUrl}>QUERO APRENDER AGORA</a>
          </div>
          <div>
            <img className="b-mega-logo" src="/images/hero/mega-oferta.webp" alt="Foco em Harmonia" />
            <p className="b-mega-sub">Comece a desenvolver sua habilidade para dividir voz e viva essa transformação hoje mesmo!</p>
          </div>
        </div>
      </section>

      <section className="b-guarantee">
        <div className="b-container b-split">
          <img className="b-guarantee-img" src="/images/oferta/%20garantia-7-dias.webp" alt="Garantia de 7 dias" />
          <div>
            <h2 className="b-title section">7 dias de garantia incondicional — <strong>ou seu dinheiro de volta!</strong></h2>
            <p>Você tem 7 dias para experimentar o treinamento “Foco em Canto”. Se por qualquer motivo você não sentir que está evoluindo ou achar que o método não é para você, devolvemos 100% do seu dinheiro, sem perguntas e sem burocracia.</p>
          </div>
        </div>
      </section>

      <section className="b-mentor">
        <div className="b-container b-split">
          <div>
            <h2 className="b-title section">Seu mentor vocal nessa jornada será <strong>Marcos Cruz</strong></h2>
            <p>Marcos Cruz é músico profissional e professor de canto, técnica vocal e piano com mais de 15 anos de experiência. Formado pela Universidade Católica do Salvador, ele já ajudou centenas de alunos a destravarem suas vozes e atua como instrutor de técnica vocal em grupos de louvor, elevando a prática vocal nas igrejas.</p>
            <p>Com os horários de aulas individuais lotados, Marcos desenvolveu a mentoria “Foco em Canto” para atender mais alunos, oferecendo uma abordagem única que traz resultados rápidos em afinação, projeção e saúde vocal.</p>
          </div>
          <img className="b-mentor-img" src="/images/hero/marcos-hero.webp" alt="Marcos Cruz" />
        </div>
      </section>
