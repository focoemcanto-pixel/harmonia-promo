...
const learnItems = [
  'Firmar sua afinação mesmo ouvindo outra voz ao mesmo tempo.',
  'Entender como encontrar a segunda voz com mais segurança.',
  'Desenvolver percepção para reconhecer caminhos harmônicos.',
  'Cantar no louvor com mais naturalidade, firmeza e confiança.',
]

const faqs = [
  ['Esse curso é para aprender a cantar do zero?', 'Não. O foco principal do Foco em Harmonia é divisão vocal: segunda voz, percepção, encaixe harmônico e prática para louvor.'],
  ['Preciso saber teoria musical?', 'Não. O método é simples, prático e direto, pensado para quem quer aprender a dividir voz mesmo sem teoria musical.'],
  ['Por quanto tempo terei acesso?', 'O acesso é vitalício. Você paga uma vez e pode estudar no seu ritmo, sempre que quiser.'],
  ['Existe garantia?', 'Sim. Você tem 7 dias de garantia incondicional para testar o treinamento sem risco.'],
]

export const metadata = {
  title: 'Foco em Harmonia — Página B',
  description: 'Página B de teste para o curso Foco em Harmonia.',
}
  ...
  return (
    <main className="lp-b">
      ...
      <section className="b-section b-dark">
        <div className="b-container b-split">
          <img className="b-img" src="/images/produto/cantor-transformacao.webp" alt="Cantor em transformação vocal" />
          <div>
      ...
      <section className="b-section b-white">
        <div className="b-container">
          ...
          <div className="b-test-grid">
            <img src="/images/depoimentos/depoimento-1.webp" alt="Depoimento" />
            <img src="/images/depoimentos/depoimento-2.webp" alt="Depoimento" />
            <img src="/images/depoimentos/depoimento-3.webp" alt="Depoimento" />
            <img src="/images/depoimentos/depoimento-4.webp" alt="Depoimento" />
          </div>
        </div>
      </section>
      ...
      <section className="b-section b-offer b-center">
        <div className="b-container">
          <div className="b-offer-card">
            ...
            <ul className="b-offer-list"><li>✓ 7 módulos de aulas completas</li><li>✓ Comunidade exclusiva para alunos</li><li>✓ Módulo bônus: como achar seu tom</li><li>✓ Teste de extensão e classificação vocal</li><li>✓ Atividades práticas para treinar divisão vocal</li><li>✓ Acesso vitalício — pague uma vez, use para sempre</li></ul>
