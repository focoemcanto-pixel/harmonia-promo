        ...
        <div className="vip-container">
          ...
          <div className="vip-hero-grid">
            ...
            <div className="vip-card vip-price-card">
              ...
              <p className="vip-small">Atenção: esta oferta especial não será exibida novamente depois que você sair desta página.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="vip-offer">
        <div className="vip-container">
          <div className="vip-offer-box">
            ...
            <br />
            <a className="vip-no" href="/">Não quero suporte VIP agora</a>
          </div>
        </div>
      </section>
